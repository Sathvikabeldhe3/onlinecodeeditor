...
export function useConfig() {
  ...
  function setFullUpdate(update) {
    localStorage.setItem("editorConfig", update);
    setConfig(JSON.parse(update));
  }

  return [config, setFunction, setFullUpdate];
}
...
export function useFileSystem() {
  ...
  function setAllFiles(allFiles) {
    setPallet([]);
    updateSource(allFiles);
    setFiles(allFiles);
  }
